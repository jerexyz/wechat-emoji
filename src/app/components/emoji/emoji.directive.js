(function() {
  ...
  function emoji() {
    var directive = {
      ...
      controllerAs: 'vm',
      templateUrl: 'app/components/emoji/emoji.html',
    ...
    function EmojiController() {
      ...
      vm.getAppendText = function(text, type) {
        switch (type) {
          case 'qq':
            text = '<img class="qqemoji qqemoji' + vm.emojiData.QQFaceMap[text] + '" text="[' + text + ']_web" src="/assets/images/spacer.gif">';
            break;
          case 'emoji':
            text = '<img class="emoji emoji' + vm.emojiData.QQFaceMap['<' + text + '>'] + '" text="[' + text + ']_web" src="/assets/images/spacer.gif">';
            break;
        }
        return text;
      }
